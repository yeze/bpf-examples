 ...
 */
static int (*bpf_sk_assign)(void *ctx, struct bpf_sock *sk, __u64 flags) = (void *) 124;
 ...
 */
static int (*bpf_seq_printf)(struct seq_file *m, const char *fmt, __u32 fmt_size, const void *data, __u32 data_len) = (void *) 125;
 ...
 * 	* **-EOVERFLOW**        Overflow happens, the same object will be tried again.
 */
static int (*bpf_seq_write)(struct seq_file *m, const void *data, __u32 len) = (void *) 126;
 ...
 */
static struct tcp6_sock *(*bpf_skc_to_tcp6_sock)(void *sk) = (void *) 127;
 ...
 * 	*sk* if casting is valid, or NULL otherwise.
 */
static struct tcp_sock *(*bpf_skc_to_tcp_sock)(void *sk) = (void *) 128;
 ...
 * 	*sk* if casting is valid, or NULL otherwise.
 */
static struct tcp_timewait_sock *(*bpf_skc_to_tcp_timewait_sock)(void *sk) = (void *) 129;
 ...
 * 	*sk* if casting is valid, or NULL otherwise.
 */
static struct tcp_request_sock *(*bpf_skc_to_tcp_request_sock)(void *sk) = (void *) 130;
 ...
 * 	*sk* if casting is valid, or NULL otherwise.
 */
static struct udp6_sock *(*bpf_skc_to_udp6_sock)(void *sk) = (void *) 131;
